...
class Applications_IndexController extends JBlac_Controller_Action
{
    ...
    public function indexAction()
    {
        ...
        $applicationMapper = new Applications_Model_ApplicationMapper('Applications_Model_DbTable_Application');
        $this->view->paginator = $applicationMapper->fetchPage($page);
    }
